...
extension ContentView_Previews {
    @_dynamicReplacement(for: previews) private static var __preview__previews: some View {
        ...
        AnyView(__designTimeSelection(ContentView(), "#1704.[2].[0].property.[0].[0]"))
#sourceLocation()
    }
}
...
extension ContentView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        AnyView(__designTimeSelection(SimpleUIView()
            .frame(width:__designTimeInteger("#1704.[1].[0].property.[0].[0].modifier[0].arg[0].value", fallback: 200), height: __designTimeInteger("#1704.[1].[0].property.[0].[0].modifier[0].arg[1].value", fallback: 200)), "#1704.[1].[0].property.[0].[0]"))
#sourceLocation()
        /*
        MapView()
            .clipShape(Circle())
